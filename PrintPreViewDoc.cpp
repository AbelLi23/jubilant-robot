...
void CPrintPreViewDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CPrintPreViewDoc::InitializeSearchContent()
{
...
void CPrintPreViewDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
